...
const getRandomEmployee = ()=>EMPLOYEES[Math.floor(Math.random() * EMPLOYEES.length)];
...
function AlertsPage() {
    ...
    if ($[0] !== "c0af4705aceca4b352f034daab46e3c5802a256701f78cbdc760ce3a98564312") {
        for(let $i = 0; $i < 54; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "c0af4705aceca4b352f034daab46e3c5802a256701f78cbdc760ce3a98564312";
    }
    let t0;
    ...
    const [alerts, setAlerts] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(t0);
    ...
    if ($[2] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = ({
            "AlertsPage[useEffect()]": ()=>{
                const load = {
                    "AlertsPage[useEffect() > load]": ()=>fetch("/api/alerts").then(_AlertsPageUseEffectLoadAnonymous).then({
                            "AlertsPage[useEffect() > load > (anonymous)()]": (data)=>{
                                if (Array.isArray(data)) {
                                    setAlerts(data);
                                }
                            }
                        }["AlertsPage[useEffect() > load > (anonymous)()]"])
                }["AlertsPage[useEffect() > load]"];
                load();
    ...
    if ($[4] === Symbol.for("react.memo_cache_sentinel")) {
        t3 = ({
            "AlertsPage[resolve]": async (id)=>{
                setAlerts({
                    "AlertsPage[resolve > setAlerts()]": (prev)=>prev.map({
                            "AlertsPage[resolve > setAlerts() > prev.map()]": (a)=>a.id === id ? {
                                    ...a,
                                    status: "Resolved"
                                } : a
                        }["AlertsPage[resolve > setAlerts() > prev.map()]"])
                }["AlertsPage[resolve > setAlerts()]"]);
    ...
    let t8;
    let t9;
    if ($[5] !== alerts || $[6] !== filter || $[7] !== searchTerm) {
        let t10;
        if ($[14] !== filter || $[15] !== searchTerm) {
            t10 = ({
                "AlertsPage[alerts.filter()]": (a_0)=>{
                    const matchesFilter = filter === "all" || filter === "active" && a_0.status === "Active" || filter === "resolved" && a_0.status === "Resolved";
                    const matchesSearch = searchTerm === "" || a_0.factory.toLowerCase().includes(searchTerm.toLowerCase()) || a_0.violationType.toLowerCase().includes(searchTerm.toLowerCase());
        ...
        const filteredAlerts = alerts.filter(t10);
        let t11;
        if ($[17] !== alerts) {
            t11 = alerts.filter(_AlertsPageAlertsFilter);
            $[17] = alerts;
            $[18] = t11;
        } else {
            t11 = $[18];
        }
        const activeCount = t11.length;
        let t12;
        if ($[19] !== alerts) {
            t12 = alerts.filter(_AlertsPageAlertsFilter2);
            $[19] = alerts;
            $[20] = t12;
        } else {
            t12 = $[20];
        }
        const resolvedCount = t12.length;
        t6 = "container py-8 space-y-8";
        let t13;
            ...
            t13 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: "Track and resolve environmental violations"
                    }, void 0, false, {
                        fileName: "[project]/src/app/alerts/page.tsx",
                        lineNumber: 125,
                        columnNumber: 89
        ...
        if ($[36] !== filter) {
            t20 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    "AlertsPage[(anonymous)()]": (f)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            onClick: {
                                "AlertsPage[(anonymous)() > <button>.onClick]": ()=>setFilter(f)
                            }["AlertsPage[(anonymous)() > <button>.onClick]"],
                            className: `px-4 py-2 rounded-md text-sm font-medium transition-colors ${filter === f ? "bg-primary text-primary-foreground" : "hover:bg-accent"}`,
        ...
        if ($[39] === Symbol.for("react.memo_cache_sentinel")) {
            t22 = ({
                "AlertsPage[<input>.onChange]": (e)=>setSearchTerm(e.target.value)
            })["AlertsPage[<input>.onChange]"];
            $[39] = t22;
        } else {
            t22 = $[39];
        }
        ...
        t4 = "card";
        t5 = filteredAlerts.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                        children: filteredAlerts.map({
                            "AlertsPage[filteredAlerts.map()]": (alert)=>{
                                const emp = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EMPLOYEES"].find({
                                    "AlertsPage[filteredAlerts.map() > EMP_LIST.find()]": (e_0)=>e_0.id === alert.assignedEmployeeId
                                }["AlertsPage[filteredAlerts.map() > EMP_LIST.find()]"]);
                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        className: "font-medium",
                                                        children: emp ? emp.name : alert.assignedEmployeeId
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/alerts/page.tsx",
                                                        lineNumber: 243,
                                                        columnNumber: 287
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                            children: alert.status === "Active" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                            className: "text-right",
                                            children: alert.status === "Active" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                onClick: {
                                                    "AlertsPage[filteredAlerts.map() > <button>.onClick]": ()=>resolve(alert.id)
    ...
    let t11;
    if ($[48] !== t10 || $[49] !== t6 || $[50] !== t7 || $[51] !== t8 || $[52] !== t9) {
...
_s(AlertsPage, "aRFBwHgJPt+61HnhQxnQo4+Y+O0=");
_c = AlertsPage;
function _AlertsPageAlertsFilter2(a_2) {
    return a_2.status === "Resolved";
}
function _AlertsPageAlertsFilter(a_1) {
    return a_1.status === "Active";
}
function _AlertsPageUseEffectLoadAnonymous(res) {
    return res.json();
}
var _c;
...
//# sourceMappingURL=_a615eb0c._.js.map